...
class titania_node:
    ...
    def __init__(self, debug=False):
        ...
        # Setup read thread
        self.titaniaCam.setReadThreadCallback(self.read_callback)
    ...
    def loop(self):
        ...
        if (connected):
            ...
            while not rospy.is_shutdown() and self.titaniaCam.isConnected:
                ...
                print("Calculated Framerate", self.capture_count)
                self.capture_count=0
                print("Internal Framerate", self.titaniaCam.getFrameRate())
                time.sleep(1)
        ...
        self.titaniaCam.stopContinousReadThread()
        self.titaniaCam.disconnect()
